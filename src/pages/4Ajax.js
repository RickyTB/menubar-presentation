        ...
        <Page>
            <div className="row">
                ...
                <div className="col-md-6">
                    ...
                    <Card>
                        <p>Se puede agregar estilos en línea en todos los componentes, y preferiblemente se puede referir a las clases de css de la siguiente lista:</p>
                        <table className="table">
                            ...
                            <tbody>
                            <tr> <td>ui-menubar</td> <td>Container element of menubar.</td></tr>
                            <tr> <td>ui-menu-list</td> <td>List container</td></tr>
                            <tr> <td>ui-menuitem</td> <td>Each menu item</td></tr>
                            <tr> <td>ui-menuitem-link</td> <td>Anchor element in a link item</td></tr>
                            <tr> <td>ui-menuitem-text</td> <td>Text element in an item</td></tr>
                            </tbody>
                        </table>
                    </Card>
                </div>
